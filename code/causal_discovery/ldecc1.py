from causal_discovery.utils import *  # 导入自定义模块或类
from causal_discovery.causal_discovery_base1 import CausalDiscoveryBase


class MNS:
    """Instantiates a Minimal Neighbor Separator (MNS). 最小邻居分隔集合 """
...
class LDECCAlgorithm(CausalDiscoveryBase):
    ...
    def __init__(self, treatment_node="X", alpha=0.05,
                 use_ci_oracle=False, graph_true=None, enable_logging=False,
